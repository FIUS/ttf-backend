...
Revision ID: 065e261b6f2f
Revises: 
Create Date: 2018-06-15 12:33:34.106390
...
def upgrade():
    ...
    sa.Column('visible_for', sa.String(length=255), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=True),
    sa.Column('name_schema', sa.String(length=255), nullable=True),
    ...
    sa.Column('deposit', sa.String(length=255), nullable=True),
    ...
    sa.Column('reason', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['item_type_id'], ['ItemType.id'], name=op.f('fk_BlacklistToItemType_item_type_id_ItemType')),
    sa.ForeignKeyConstraint(['user_id'], ['Blacklist.id'], name=op.f('fk_BlacklistToItemType_user_id_Blacklist')),
    ...
    sa.Column('deleted', sa.Boolean(), nullable=True),
    sa.Column('visible_for', sa.String(length=255), nullable=True),
    sa.ForeignKeyConstraint(['type_id'], ['ItemType.id'], name=op.f('fk_Item_type_id_ItemType')),
    ...
    sa.ForeignKeyConstraint(['attribute_definition_id'], ['AttributeDefinition.id'], name=op.f('fk_ItemTypeToAttributeDefinition_attribute_definition_id_AttributeDefinition')),
    sa.ForeignKeyConstraint(['item_type_id'], ['ItemType.id'], name=op.f('fk_ItemTypeToAttributeDefinition_item_type_id_ItemType')),
    ...
    sa.Column('item_type_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['item_type_id'], ['ItemType.id'], name=op.f('fk_ItemTypeToItemType_item_type_id_ItemType')),
    sa.ForeignKeyConstraint(['parent_id'], ['ItemType.id'], name=op.f('fk_ItemTypeToItemType_parent_id_ItemType'), ondelete='CASCADE'),
    ...
    sa.Column('attribute_definition_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['attribute_definition_id'], ['AttributeDefinition.id'], name=op.f('fk_TagToAttributeDefinition_attribute_definition_id_AttributeDefinition')),
    sa.ForeignKeyConstraint(['tag_id'], ['Tag.id'], name=op.f('fk_TagToAttributeDefinition_tag_id_Tag')),
    ...
    sa.ForeignKeyConstraint(['item_id'], ['Item.id'], name=op.f('fk_File_item_id_Item')),
    ...
    sa.Column('deleted', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['attribute_definition_id'], ['AttributeDefinition.id'], name=op.f('fk_ItemToAttributeDefinition_attribute_definition_id_AttributeDefinition')),
    sa.ForeignKeyConstraint(['item_id'], ['Item.id'], name=op.f('fk_ItemToAttributeDefinition_item_id_Item')),
    sa.PrimaryKeyConstraint('item_id', 'attribute_definition_id', name=op.f('pk_ItemToAttributeDefinition'))
    )
    op.create_table('ItemToItem',
    sa.Column('parent_id', sa.Integer(), nullable=False),
    sa.Column('item_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['item_id'], ['Item.id'], name=op.f('fk_ItemToItem_item_id_Item')),
    sa.ForeignKeyConstraint(['parent_id'], ['Item.id'], name=op.f('fk_ItemToItem_parent_id_Item')),
    ...
    sa.ForeignKeyConstraint(['item_id'], ['Item.id'], name=op.f('fk_ItemToLending_item_id_Item')),
    sa.ForeignKeyConstraint(['lending_id'], ['Lending.id'], name=op.f('fk_ItemToLending_lending_id_Lending')),
    sa.PrimaryKeyConstraint('item_id', 'lending_id', name=op.f('pk_ItemToLending'))
    )
    op.create_table('ItemToTag',
    sa.Column('item_id', sa.Integer(), nullable=False),
    sa.Column('tag_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['item_id'], ['Item.id'], name=op.f('fk_ItemToTag_item_id_Item')),
    sa.ForeignKeyConstraint(['tag_id'], ['Tag.id'], name=op.f('fk_ItemToTag_tag_id_Tag')),
